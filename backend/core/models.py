...
from core.schemas import Platform # Import Platform for the static method
...
class User(Base):
    ...
    meeting_links = relationship("UserMeeting", back_populates="user")
...
class UserMeeting(Base):
    ...
    meeting = relationship("Meeting", back_populates="user_links")
...
class Meeting(Base):
    ...
    # Add relationship to the junction table
    user_links = relationship("UserMeeting", back_populates="meeting")
    ...
    # Add composite index for efficient lookup by platform and native ID
    __table_args__ = (
        Index(
            'ix_meeting_platform_native_id_created_at',
            'platform',
